...
class Father{
    ...
    //     //this.carname = brand;
    // }
    demofuncfather(readlineSync, fs){
        this.readlineSync = readlineSync;
        this.fs = fs;
        var doctor = JSON.parse(fs.readFileSync("/home/administrator/Desktop/Shakti/OOP/Clinique_json/doctors.json"));
        var patient = JSON.parse(fs.readFileSync("/home/administrator/Desktop/Shakti/OOP/Clinique_json/patients.json"));
    }
    }
class Son extends Father{
    ...
    demofunc(){
        ...
        fs.writeFile("/home/administrator/Desktop/Shakti/OOP/Clinique_json/doctors.json", JSON.stringify(doctor), (err) => {     
            // In case of a error throw err. 
            if (err) throw err; 
        })
        fs.writeFile("/home/administrator/Desktop/Shakti/OOP/Clinique_json/patients.json", JSON.stringify(patient), (err) => {     
            // In case of a error throw err. 
            if (err) throw err; 
        }) 
    }
...
sun = new Son();
sun.demofuncfather(readlineSync, fs);
sun.demofunc();
